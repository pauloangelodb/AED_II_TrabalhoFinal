...
public class Aplicacao {
	...
	static void RelatorioCategoria(int[] dados) {
		JOptionPane.showMessageDialog(null, 
				"\n------------------------------------------------------------------------------------------\n" +
						...
						"\n------------------------------------------------------------------------------------------\n" +	
						"\nMoradia\n" +
						"Urbana: " + dados[7] + " (" + porcentagem(dados[7], dados[0]) + "%)" + "\n" +
						"Rural: " + dados[8] + " (" + porcentagem(dados[8], dados[0]) + "%)" + "\n" +
						"\n-----------------------------------------------------------------------------------------\n" +		
						"\nFaixa Etária\n" +
	...
	static void RelatorioEstatistico(int[] dados) {
		JOptionPane.showMessageDialog(null, 
				"\n------------------------------------------------------------------------------------------\n" +
						...
						"Solteiros:   " + media(dados[26],dados[3]) + " anos" + "                        " + dados[28] + "\n" +
						"Casados:    " + media(dados[27],dados[4]) + " anos" + "                        " + dados[29] + "\n" +
						"------------------------------------------------------------------------------------------\n\n"
						, null, 1);
	}
}
